...
const template = new Template("html/pages/news.html");

export const NewsPage = Object.freeze({
  build,
  parent: null,
  secret: false
});
...
function showArticles(root, paginator, controller) {
  ...
  for (let article of controller.items) {
    let li = template.queryById("article");
